# Classification: Equilibrium configuration strategy of vehicle-to-grid-based electric vehicle charging stations in low-carbon resilient distribution networks

**Key:** equilibrium_configuration_2024
**arXiv ID:** 
