# Classification: Fast-charging station location problem: A two-phase approach with mathematical program with equilibrium constraints considering charging choice behaviour

**Key:** fast-charging_station_2023
**arXiv ID:** 
