...
\subsubsection{From centrelines to arterial zones}\label{sec:derived_AZ}
...
\subsubsection{From \gls{fsa}-level \gls{bev} counts to arterial zones' \gls{bev} densities}\label{sec:Ev_density_for AZ}
...
\begin{align}
  ...
  \widehat{\mathcal{R}}^{\mathrm{Ar}}
   ...
   \,\bigr\}.
\end{align}
\subsubsection{Graph construction and hop distance}
...
\subsubsection{Weighted $n$-hop smoothing}
...
\subsubsection{Ridge paths as \gls{bev} activity backbones}\label{sec:Ridge paths}
...
\paragraph{Ridge path extraction}
...
\subsubsection{Graph-based proximity evaluation}
...
\paragraph{Charger capacity density as supply proxy}
...
\paragraph{Weighted proximity distance metric}
...
\paragraph{Proximity Evaluation Algorithm}
...
\subsubsection{Evaluating charger–activity spatial alignment}
...
\paragraph{Null distribution construction}
...
\end{align}
\paragraph{Elbow analysis for convergence detection}
...
% \subsubsection{Meso-Level Planning Toolkit}
...
\subsubsection{Study area and datasets}
...
\subsubsection{Arterial zone extraction}\label{subsec:az_extraction}
...
\end{figure}
\subsubsection{Arterial zones' \gls{bev} densities}
...
% \subsubsection{Preprocessing and Spatial Setup}
...
\subsubsection{Graph constraction}
...
%========================
\paragraph{Graph-theoretic analysis of the arterial adjacency network}
...
\subsubsection{Proximity analysis between ridge zones and the \gls{dcfc} network}
...
% \subsubsection{Proximity Performance (Observed)}
...
% \subsubsection{Null Distribution and Significance}
...
% \subsubsection{Sensitivity and Ablation Analyses}
...
% \subsubsection{Targeted Corridor Diagnostics (Actionable Gaps)}
...
% \subsubsection{Computation and Reproducibility}
